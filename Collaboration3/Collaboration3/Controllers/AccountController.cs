...
using static Collaboration3.Controllers.ManageController;
using static Collaboration3.Models.RegisterViewModel;
using System;
...
namespace Collaboration3.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                switch (result)
                {
                    ...
                    //If Sign in is succesfull return user to there profile
                        returnUrl = "Profile";
        ...
        public async Task<ActionResult> Register(ExtendedIdentityModels model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, JobTitle = model.JobTitle, TeamName = model.TeamName , ImageByte = data};
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public new ActionResult Profile(ProfileView model)
        {
